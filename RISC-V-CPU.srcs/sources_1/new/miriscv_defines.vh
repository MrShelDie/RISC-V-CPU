...
`define CSR_INT          3'b100

`define JALR_MTVEC        2'b11
`define JALR_MEPC         2'b10

/* MRET https://msyksphinz-self.github.io/riscv-isadoc/html/rvi.html#mret */
`define MRET             25'b00110_00_00010_00000_000_00000

`define RDSEL_MEM         2'b00
`define RDSEL_DEV0        2'b01
`define RDSEL_DEV1        2'b10
