...
HD_PWD='D:/VivadoProj/RISC-V-CPU/RISC-V-CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_miriscv_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_miriscv_top.tcl
