...
HD_PWD='C:/Users/8200386/Desktop/ALU_RISC-V/ALU_RISC-V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ALU_RISCV.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ALU_RISCV.tcl
